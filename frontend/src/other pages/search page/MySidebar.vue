<template>
    <div class="sidebar">
        ...
        <div class="fc-wrapper">
            <FirstCondition v-for="(fc, index) in fcs" :fc="fc" :index="index"></FirstCondition>
        </div>
